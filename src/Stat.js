...
import Thurgau6 from './pictures/thurgau6.jpg'
      ...
      <div>
        <div className="top">
          ...
          <div className="topitemtitel">
            ...
            <p id="utitle">
              Diese Website gewährt den Zugriff auf die Daten aller Lernenden des Kantons Thurgau.<br></br>
        ...
        <div className="statistik-outer">
          <div className="statistik-inner">
            <div id="st" className="statheader">
              <label
  ...
  return (
    <div className="App" id="ga">
      ...
      <div className="infobulk">
        ...
        <div id="gameinner">
          <button className="info" alt="keinbild" onClick={info}>
            i
          </button>
        </div>
      </div>
      <div>
        <div className="grid1">
          <div className="item1" id="colorchange1" onClick={clickHandler}>
            <div className="inner">
          ...
          <div className="item1" id="colorchange2" onClick={clickHandler2}>
            <div className="inner">
  ...
  return (
   <div>
     <div className="centertitle">
      <h1 className="titlegal" id="sg">Gallerie</h1>
      </div>
      <div className="gridcenter">
    <div className="photo-grid">
      <div className="card card-tall card-wide" style={{backgroundImage: `url(${Thurgau1})`}}></div>
      <div className="card card-tall card-wide" style={{backgroundImage: `url(${Thurgau2})`}}></div>
      <div className="card card-tall card-wide" style={{backgroundImage: `url(${Thurgau3})`}}></div>
      <div className="card card-tall card-wide" style={{backgroundImage: `url(${Thurgau4})`}}></div>
      <div className="card card-tall card-wide" style={{backgroundImage: `url(${Thurgau5})`}}></div>
      <div className="card card-tall card-wide" style={{backgroundImage: `url(${Thurgau6})`}}></div>
      <div className="card card-tall card-wide" style={{backgroundImage: `url(${Thurgau7})`}}></div>
      <div className="card card-tall card-wide" style={{backgroundImage: `url(${Thurgau8})`}}></div>
      <div className="card card-tall card-wide" style={{backgroundImage: `url(${Thurgau9})`}}></div>
      <div className="card card-tall card-wide" style={{backgroundImage: `url(${Thurgau10})`}}></div>
      <div className="card card-tall card-wide" style={{backgroundImage: `url(${Thurgau11})`}}></div>
      <div className="card card-tall card-wide" style={{backgroundImage: `url(${Thurgau12})`}}></div>
      </div>
    </div>
    </div>
  )
  ...
  return (
    <div className="footer-outer">
      <div className="footer-inner">
        <h1>Kontakt: andrej.bulavcak@stud.kftg.ch / clemens.frei@stud.kftg.ch</h1>
        <h1>Diese Website wurde im Rahmen der Projektwoche 2021 in der Kanti Frauenfeld realisiert.<br></br>Die benutzten Daten wurden von opendata.swiss bereitgestellt.</h1>
      </div>
  </div>
  )
}
